...
INSERT INTO `user` VALUES(1,'fraleone99@gmail.com','francesco','password1',false,0,null);
INSERT INTO `user` VALUES(2,'lorenzoiovine@gmail.com','lorenzo','password2',false,0,null);
...
INSERT INTO `service` VALUES(2,'mobilePhone',500,500,0.30,0.15,0,0);
INSERT INTO `service` VALUES(3,'fixedInternet',0,0,0,0,50,0.50);
INSERT INTO `service` VALUES(4,'mobileInternet',0,0,0,0,15,0.50);
...
INSERT INTO `optionalProduct` VALUES(1,'TV channel',2,'franco');
INSERT INTO `optionalProduct` VALUES(2,'Weather Forecasts',3,'lorenzo');
...
INSERT INTO `employee` VALUES('lorenzo','lorenzo');
...
INSERT INTO `bestSeller` VALUES(1,'TV channel',0,0);
INSERT INTO `bestSeller` VALUES(2,'Weather Forecasts',0,0);
...
BEGIN
    ...
    IF (new.isValid=1) THEN
        ...
        getId: LOOP
            ...
            UPDATE bestSeller
            SET valueOfSales = soldNumber * (SELECT monthlyFee FROM optionalProduct WHERE id=optionalIdSel)
            WHERE optionalId = optionalIdSel;
        END LOOP getId;
        CLOSE cur1;
    END IF;
